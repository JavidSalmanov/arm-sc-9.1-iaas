param(
    [string] $folderpath = "C:\Scripts",
    [string] $inifile = "$folderpath\ConfigurationFile.ini",
    [string] $yourusername = "$env:COMPUTERNAME\$env:USERNAME",
    [string] $sqlInstacePassword = "A123456789a!"
)
...
Start-BitsTransfer -Source "https://go.microsoft.com/fwlink/?linkid=853016" -Destination "$folderpath\setup.exe" -Verbose
